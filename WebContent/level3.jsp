...
<%
	...
	userdao.updateCurrentPage(session.getAttribute("username").toString(),"level3.jsp");
%>
...
<body style="background-color: #222">
  ...
  <svg id="game" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 400" overflow="visible">
	...
	<a href="level3.html"><ellipse cx="200" cy="80" rx="100" ry="50" style="fill: gray; stroke: black; stroke-width:2; align-self: center;"/><text x="125" y="90" font-family="Verdana" font-size="35" fill="black">Oh! No</text></a></svg>
	...
	<a href="hard1.jsp"><ellipse cx="200" cy="80" rx="100" ry="50" style="fill: gray; stroke: black; stroke-width:2;"/><text x="110" y="90" font-family="Verdana" font-size="35" fill="black">Click Me</text></a></svg>
